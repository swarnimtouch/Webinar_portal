...
Route::middleware(['auth:admin'])->group(function () {
    ...
    Route::get('speakers/create/{id?}',[SpeakersController::class, 'addEditForm'])    ->name('speaker.create');
    ...
    Route::delete('admin/delete/{id}', [SpeakersController::class, 'delete'])->name('speaker.delete');


    Route::get('brand',[BrandsController::class, 'index'])    ->name('brand');
    Route::get('brand/create/{id?}', [BrandsController::class, 'addEditForm'])->name('brand.create');
    ...
    Route::post('user_attendance/delete-multiple', [UserAttendenceController::class, 'deleteMultiple'])->name('user_attendance.deleteMultiple');
    Route::get('user_attendance/datatable', [UserAttendenceController::class, 'datatable'])->name('user_attendance.datatable');
