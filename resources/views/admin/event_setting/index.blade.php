            ...
            <div id="kt_content_container" class="container-xxl">
                <div class="card">
                    ...
                    <div class="card-body border-top p-9">
                        <form method="POST" action="{{ route('admin.event_setting.save') }}" id="kt_event_form"
                            ...
                            <div class="row mb-6">
                                <label class="col-lg-4 col-form-label required fw-bold fs-6">Is Log Attendance?</label>
                                <div class="col-lg-8">
                                    <div class="form-check form-switch form-check-custom form-check-solid">
                                        <input class="form-check-input" type="checkbox" name="is_log_attendance"
                                               id="is_log_attendance"
