                    ...
                    <div class="card-toolbar">
                        ...
                        <div class="d-flex justify-content-end align-items-center d-none"
                            ...
                            <div class="fw-bolder me-5">
                                <span class="me-2" data-kt-chat-message-table-select="selected_count"></span> Selected
                            </div>
...
function initChatMessageTable() {
    chatMessageTable = $('#kt_table_chat_messages').DataTable({
        ...
        searching: false,
        ajax: {
            url: '{{ route("admin.chatmessage.datatable") }}',
            data: d => {
...
document.querySelector('[data-kt-chat-message-table-select="delete_selected"]')
    ?.addEventListener('click', () => {
        ...
        Swal.fire({
            ...
            fetch('{{ route("admin.chatmessage.deleteMultiple") }}', {
                method: 'POST',
                headers: {
...
document.addEventListener('click', function (e) {
    ...
    Swal.fire({
        ...
        $.ajax({
            url: '{{ route("admin.chatmessage.delete", ":id") }}'.replace(':id', id),
            type: 'DELETE',
            data: {
                _token: '{{ csrf_token() }}'
            },
