            ...
            <div id="kt_content_container" class="container-xxl">
                ...
                <div class="card">
                    ...
                    <div class="card-body border-top p-9">
                        <form method="POST"
                              action="{{ route('admin.home_setting.save', $homeSetting->id ?? null) }}"
                              id="kt_home_setting_form">
                            ...
                            <div class="row mb-6">
                                ...
                                <div class="col-lg-8">
                                    <input type="text"
                                           ...
                                           value="{{ old('publish_date', $homeSetting->publish_date?->format('d M Y')) }}"/>
                                </div>
                            </div>
                            ...
                            <div class="row mb-6">
                                ...
                                <div class="col-lg-8">
                                    <input type="text"
                                           ...
                                           value="{{ old('event_start_time', $homeSetting->event_start_time?->format('d M Y H:i')) }}"/>
                                </div>
                            </div>
                            ...
                            <div class="row mb-6">
                                ...
                                <div class="col-lg-8">
                                    <input type="text"
                                           ...
                                           value="{{ old('event_end_time', $homeSetting->event_end_time?->format('d M Y H:i')) }}"/>
                                </div>
                            </div>
                            ...
                            <div class="row mb-6">
                                ...
                                <div class="col-lg-8">
                                    <input type="text"
                                           ...
                                           value="{{ old('active_from_date', $homeSetting->active_from_date?->format('d M Y H:i')) }}"/>
                                </div>
                            </div>
                            ...
                            <div class="row mb-6">
                                ...
                                <div class="col-lg-8">
                                    <input type="text"
                                           ...
                                           value="{{ old('active_to_date', $homeSetting->active_to_date?->format('d M Y H:i')) }}"/>
                                </div>
                            </div>
